  ...
  <div>
    <el-row>
      <el-col :span="12">
            ...
            <el-row>
              <el-col>
                <el-form-item label="ip">
                  <el-input v-model="hkvInfo.ip" placeholder="ip" />
                </el-form-item>
                <el-form-item label="port">
                  <el-input v-model="hkvInfo.port" placeholder="port" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col>
                <div>
                  <el-form-item label="username">
                    <el-input v-model="hkvInfo.username" placeholder="username" />
                  </el-form-item>
                  <el-form-item label="password">
                    <el-input v-model="hkvInfo.password" placeholder="password" />
                  </el-form-item>
                </div>
              </el-col>
            </el-row>
        ...
        <div>
          <label>数字通道列表: </label>
          <el-tag v-for="(item,index) in hkvInfo.channels" :key="index" type="success" class="my-tag">{{ item }}</el-tag>
        </div>
      </el-col>
      <el-col :span="12">
