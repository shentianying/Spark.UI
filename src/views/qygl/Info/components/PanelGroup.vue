    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('car')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="410" :duration="10" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('device')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="212" :duration="10" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('people')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="280" :duration="10" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('visitor')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="60" :duration="10" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
