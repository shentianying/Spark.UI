<template>
  <div class="app-container">
    <div v-show="active===0">
      ...
      >
        <el-row :gutter="10">
          <el-col :sm="12" :xs="24">
            ...
            <el-form-item label="暂退日期" prop="pauseDate">
              <el-date-picker
                v-model="ruleForm.pauseDate"
                type="date"
          ...
          <el-col :sm="12" :xs="24">
            ...
            <el-form-item label="暂退原因" prop="pauseReason">
              <el-input v-model="ruleForm.pauseReason" type="textarea" :rows="4" size="mini" maxlength="500" />
            </el-form-item>
      ...
      >
        ...
        <el-table-column label="暂退原因" align="center" min-width="200">
          <template slot-scope="scope">
            <el-input v-model="scope.row.pauseReason" placeholder="请输入" size="mini" maxlength="200" />
          </template>
        </el-table-column>
    ...
    <select-worker-2 ref="workerRef" :multiple="true" :org-ids="orgIdList" :ispause="false" :worker-list="workerList" @getPersons="getPersons" />
  </div>
</template>
<script>
import { getFormById, getBillFlow, saveData, deleteData } from '@/api/ggzx/workerPause'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        pauseReason: [{ required: true, message: '请输入', trigger: 'blur' }],
      ...
      this.$refs['ruleForm'].validate(valid => {
        if (valid) {
          ...
          const postdata = {
            ...
            orgId: newObj.orgId,
            year: newObj.year,
            pauseReason: newObj.pauseReason,
            pauseDate: newObj.pauseDate,
            remark: newObj.remark,
            fileList: newObj.fileList,
            state: newObj.state,
            workerPauseDetails: details,
            billFlow: billFlow
          }
      ...
      if ((personList || []).length > 0) {
        ...
        personList.forEach(person => {
          data.push({
            ...
            pauseReason: this.ruleForm.pauseReason,
            pauseDate: this.ruleForm.pauseDate,
            remark: ''
          })
          workers.push(person)
        })
