<template>
  <div class="app-container">
      ...
      <el-row :gutter="10">
        <el-col :sm="12" :xs="24">
          ...
          <el-form-item label="合同编号">
            <el-link :underline="false" @click="openContract(ruleForm.contract.id)">{{ ruleForm.contract.number }}</el-link>
          </el-form-item>
    ...
    >
      ...
      <el-table-column label="计划单主数量" align="center" width="60">
        <template slot-scope="scope">
          {{ scope.row.planDetail.applicationQuantity }}
        </template>
      </el-table-column>
      ...
      <el-table-column v-if="columnShow.unit2" label="计划单辅数量" align="center" width="60">
        <template slot-scope="scope">
          {{ scope.row.planDetail.applicationQuantity2 }}
        </template>
      </el-table-column>
...
<script>
import { getOrderById, addAttitude } from '@/api/cggl/order'
