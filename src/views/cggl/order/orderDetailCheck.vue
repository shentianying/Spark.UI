<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="订单编号" min-width="10">
    ...
    >
      ...
      <el-table-column label="订单主数量" align="center" width="200">
        <template slot-scope="scope">
          {{ scope.row.quantity }}
        </template>
      </el-table-column>
      ...
      <el-table-column v-if="columnShow.unit2" label="订单辅数量" align="center" width="200">
        <template slot-scope="scope">
          {{ scope.row.quantity2 }}
        </template>
      </el-table-column>
...
<script>
import { getOrderPagingWithDetail } from '@/api/cggl/order'
...
export default {
  ...
  methods: {
    async fetchData() {
      ...
      if (this.obj !== null) postData.supplierIds.push(this.obj.supplierId)
      postData.categoryName = this.search.categoryName
      getOrderPagingWithDetail(postData).then(response => {
