    ...
    >
      <el-row :gutter="10">
        ...
        <el-col :sm="12" :xs="24">
          ...
          <el-form-item label="主数量" prop="applicationQuantity">
            <el-input v-model="ruleForm.applicationQuantity" size="mini" />
          </el-form-item>
          <el-form-item v-if="categoryPropertyList && categoryPropertyList.filter(f=>f.property.materialField==='unit2').length" label="辅数量" prop="applicationQuantity2">
            <el-input v-model="ruleForm.applicationQuantity2" size="mini" />
          </el-form-item>
